...
- weird geometries. Supported shapes goes beyond smooth convex distributions: map of Indonesia, a sponge, a donuts, an elephant, an eggshell with a 2d grid shape... but with some limits. Bad fits: same eggshell with a 3d grid shape, a leafless tree, a wind turbine... the issue is not that gridpoints cannot sort these distributions, but that it will produce a poor representation of the geometry.
